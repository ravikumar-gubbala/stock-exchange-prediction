...
public class load2Mongo {
	...
	public static void downloadFile(URL url, String outputFileName) throws IOException {
	      ...
	      connection.setRequestProperty("Referer","https://www1.nseindia.com/products/content/equities/equities/archieve_eq.htm");
	      connection.connect();
	...
	public static void loadMain(String[] args)  throws Exception {
		
		System.out.printf("Enter Name of the Database: ");
		Scanner scanner = new Scanner(System.in);
	    String gDatabaseName = scanner.nextLine();
	    System.out.printf("Enter Name of the Collection: ");
	    String gCollectionName = scanner.nextLine();
	    ...
	    try {
		    String gDateStr = scanner.nextLine();
	    ...
	    try {
		 ...
		 while(g10Days<10)
		 {
			 ...
			 { gUrlStr5 = ""; }
			 gUrlStr2 = gYear.toString() +"/" + gMonthStr + "/" + "cm" + gUrlStr5 + gDay.toString()
			 				+ gMonthStr + gYear.toString() + gUrlStr3;
			 ...
			 if(saturday==true || sunday == true) { continue; }
...
/****Upload2DB****/
		 ...
		 while(g10Days<10)
		 {
			 ...
			 System.out.println("Uploading File Press Enter Key...to Proceed.... "+inpFile.toString());
			 String gTMPName = scanner.nextLine();
		 ...
		 System.out.printf("Upload to MongoDB Success, End of Program!!!");
		 System.exit(0);
